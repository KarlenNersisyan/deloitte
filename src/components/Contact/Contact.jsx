...
export default function Contact({ isEmail }) {
  ...
  return (
    <>
      <div
        className={cn([classes.general], { [classes.hide]: !isEmail })}
      >
        <div
          className={cn([classes.backContainer], { [classes.hide]: !isClose })}
        >
          <div className={classes.formContainer}>
            <div className={classes.header}>
              ...
              <button
                ...
                className={classes.headerElement3}
              >
                X
              </button>
            </div>
              ...
              <div className={classes.info}>
                ...
                <div className={classes.policy}>
                  ...
                  <label htmlFor="yah" className={classes.labEl}>
                    ...
                    subject to Deloitte's <a href="#!">Privacy Statement </a>{" "}
                    and <a href="#!">Legal Terms</a>*
                  </label>
                </div>
              </div>
